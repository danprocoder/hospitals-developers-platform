...
export default function () {
  return (
    <TableOfContent active='api-docs-nearby'>
      <div className='page api-doc'>
        <h2 className='header'>Getting health centres within a certain radius</h2>
        <div className='content'>
          <div className='section m-top-40'>
            <ScrollSpy spyOn={['url', 'url-parameters', 'example']} menuListId='menu-nearby'>
        ...
        <div className='pagination'>
          <Link to='/documentation/api-doc/specific-location'>&larr; Getting health centres in a specific location</Link>
        </div>
      </div>
    </TableOfContent>
  )
